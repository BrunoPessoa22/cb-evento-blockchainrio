        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:py-24 lg:grid-cols-2 lg:gap-20">
          <Reveal>
            ...
            <p className="mt-6 max-w-md leading-relaxed text-[var(--paper-mute)]">
              O jantar é gratuito e as vagas são limitadas — a curadoria prioriza quem
              decide sobre tecnologia e inovação na empresa. Confirmação imediata por
              e-mail, com convite de calendário.
            </p>
          </Reveal>
          <Reveal>
            <SignupForm />
